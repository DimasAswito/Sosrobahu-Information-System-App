...
class PengaturanHargaAdapter(val action: PengaturanHargaAction) :
    ListAdapter<DistributorBarangItems, PengaturanHargaAdapter.ViewHolder>(PengaturanHargaDiffUtil()) {
