...
class DetailPesananDistributorViewModel(private val detailPesananMasukDistributorUseCase: DetailPesananMasukDistributorUseCase) :
    ViewModel() {
    ...
    fun getDetailPesananMasuk(idOrder: Int) {
        ...
        viewModelScope.launch {
            ...
            when (data) {
                ...
                is DataResult.Success -> _state.update { it.copy(data = data.data, isLoading = false) }
            }
        }
    }
}