...
class TambahOrderSalesAdapter(
    private val onQuantityChangeListener: OnQuantityChangeListener
) : ListAdapter<SelectedProdukSales, TambahOrderSalesAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(private val binding: ItemTambahOrderAgenBinding) :
        ...
        fun bind(item: SelectedProdukSales) {
            // Load image
            ...
            binding.txtHargaSatuan.text = item.item.harga.toRupiah()
        ...
        private fun attachNewTextWatcher(item: SelectedProdukSales) {
    ...
    class DiffCallback : DiffUtil.ItemCallback<SelectedProdukSales>() {
        override fun areItemsTheSame(
            oldItem: SelectedProdukSales,
            newItem: SelectedProdukSales
        ): Boolean = oldItem.item.idBarangAgen == newItem.item.idBarangAgen
    ...
    interface OnQuantityChangeListener {
        fun onQuantityChanged(item: SelectedProdukSales, newQty: Int)
    }
}