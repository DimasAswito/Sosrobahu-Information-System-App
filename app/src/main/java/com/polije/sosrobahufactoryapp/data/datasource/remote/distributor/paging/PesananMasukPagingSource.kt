...
class PesananMasukPagingSource(
    ...
    override fun getRefreshKey(state: PagingState<Int, PesananMasukDistributorDataItem>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PesananMasukDistributorDataItem> {
