...
class ListTokoSalesPagingSource(
...
) : PagingSource<Int, ListSalesDataItem>() {
    override fun getRefreshKey(state: PagingState<Int, ListSalesDataItem>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ListSalesDataItem> {
